...
struct EBOBeforeTaxCashflowsView: View {
    ...
    var body: some View {
        VStack {
            HeaderView(headerType: .report, name: "EBO Before-Tax Cashflows", viewAsPct: myViewAsPct, goBack: myGoBack, withBackButton: true, withPctButton: true, path: $path, isDark: $isDark)
            Form {
