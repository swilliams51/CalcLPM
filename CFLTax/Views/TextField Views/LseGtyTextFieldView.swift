...
struct LseGtyTextFieldView: View {
    ...
    var body: some View {
        ...
        .onAppear{
            self.amountOnEntry = myInvestment.asset.lesseeGuarantyAmount
            self.maximumAmount = maximumLessorCost.toDecimal()
            self.myAmount = myInvestment.asset.lesseeGuarantyAmount
...
#Preview {
    LseGtyTextFieldView(myInvestment: Investment(), path: .constant([Int]()), isDark: .constant(false ))
}


extension LseGtyTextFieldView {
