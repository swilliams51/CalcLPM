...
struct FeeExpenseView: View {
    ...
    var body: some View {
       ...
       .onAppear {
           ...
           myFeeAmortization.createTable(aFee: myInvestment.fee, aAssetCost: myInvestment.asset.lessorCost, aMaturityDate: myInvestment.getLeaseMaturityDate(), aFiscalMonth: myInvestment.taxAssumptions.fiscalMonthEnd.rawValue)
       }
    }
}
