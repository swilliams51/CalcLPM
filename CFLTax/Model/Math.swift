...
public func safeDivision (aNumerator: Decimal, aDenominator: Decimal) -> Decimal {
...
func pv (annualRate: Decimal, noOfPayments: Int, pmtAmount: Decimal, freq: Frequency, timing: TimingType) -> Decimal {
