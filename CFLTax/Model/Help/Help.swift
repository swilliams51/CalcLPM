...
let maxGuarantyHelp =    Help(title: "Maximum Guaranty", instruction: "The maximum amount of residual that can be guaranteed by the lessee such that the present value of the rents and the residual guaranty are less than 90% of the Lessor's Cost when discounted at the Implicit Rate.")
