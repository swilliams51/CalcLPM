...
public let alertYieldCalculationError = "There is one or more isssues with the input parameters that will cause the yield calculation to produce an error.  Consequently, the current calculation has been terminated."
